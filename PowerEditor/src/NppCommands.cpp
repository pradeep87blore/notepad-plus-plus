...
void Notepad_plus::command(int id)
{
	switch (id)
	{
		...
		case IDM_SEARCH_MARKALLEXT6 :
		case IDM_SEARCH_MARKALLEXT7 :
		case IDM_SEARCH_MARKALLEXT8 :
		case IDM_SEARCH_MARKALLEXT9 :
		case IDM_SEARCH_MARKALLEXT10 :
		{
			int styleID;
			...
			else if (id == IDM_SEARCH_MARKALLEXT5)
				styleID = SCE_UNIVERSAL_FOUND_STYLE_EXT5;
			else if (id == IDM_SEARCH_MARKALLEXT6)
				styleID = SCE_UNIVERSAL_FOUND_STYLE_EXT6;
			else if (id == IDM_SEARCH_MARKALLEXT7)
				styleID = SCE_UNIVERSAL_FOUND_STYLE_EXT7;
			else if (id == IDM_SEARCH_MARKALLEXT8)
				styleID = SCE_UNIVERSAL_FOUND_STYLE_EXT8;
			else if (id == IDM_SEARCH_MARKALLEXT9)
				styleID = SCE_UNIVERSAL_FOUND_STYLE_EXT9;
			else // (id == IDM_SEARCH_MARKALLEXT10)
				styleID = SCE_UNIVERSAL_FOUND_STYLE_EXT10;
		...
		case IDM_SEARCH_UNMARKALLEXT6 :
		case IDM_SEARCH_UNMARKALLEXT7 :
		case IDM_SEARCH_UNMARKALLEXT8 :
		case IDM_SEARCH_UNMARKALLEXT9 :
		case IDM_SEARCH_UNMARKALLEXT10 :
		{
			int styleID;
			if (id == IDM_SEARCH_UNMARKALLEXT1)
				...
				styleID = SCE_UNIVERSAL_FOUND_STYLE_EXT4;
			else if (id == IDM_SEARCH_UNMARKALLEXT5)
				styleID = SCE_UNIVERSAL_FOUND_STYLE_EXT5;
			else if (id == IDM_SEARCH_UNMARKALLEXT6)
				styleID = SCE_UNIVERSAL_FOUND_STYLE_EXT6;
			else if (id == IDM_SEARCH_UNMARKALLEXT7)
				styleID = SCE_UNIVERSAL_FOUND_STYLE_EXT7;
			else if (id == IDM_SEARCH_UNMARKALLEXT8)
				styleID = SCE_UNIVERSAL_FOUND_STYLE_EXT8;
			else if (id == IDM_SEARCH_UNMARKALLEXT9)
				styleID = SCE_UNIVERSAL_FOUND_STYLE_EXT9;
			else // (id == IDM_SEARCH_UNMARKALLEXT10)
				styleID = SCE_UNIVERSAL_FOUND_STYLE_EXT10;
		...
		case IDM_SEARCH_GONEXTMARKER6 :
		case IDM_SEARCH_GONEXTMARKER7 :
		case IDM_SEARCH_GONEXTMARKER8 :
		case IDM_SEARCH_GONEXTMARKER9 :
		case IDM_SEARCH_GONEXTMARKER10 :
		case IDM_SEARCH_GONEXTMARKER_DEF :
		{
			...
			if (id == IDM_SEARCH_GONEXTMARKER1)
				...
				styleID = SCE_UNIVERSAL_FOUND_STYLE_EXT5;
			else if (id == IDM_SEARCH_GONEXTMARKER6)
				styleID = SCE_UNIVERSAL_FOUND_STYLE_EXT6;
			else if (id == IDM_SEARCH_GONEXTMARKER7)
				styleID = SCE_UNIVERSAL_FOUND_STYLE_EXT7;
			else if (id == IDM_SEARCH_GONEXTMARKER8)
				styleID = SCE_UNIVERSAL_FOUND_STYLE_EXT8;
			else if (id == IDM_SEARCH_GONEXTMARKER9)
				styleID = SCE_UNIVERSAL_FOUND_STYLE_EXT9;
			else if (id == IDM_SEARCH_GONEXTMARKER10)
				styleID = SCE_UNIVERSAL_FOUND_STYLE_EXT10;
		...
		case IDM_SEARCH_GOPREVMARKER6 :
		case IDM_SEARCH_GOPREVMARKER7 :
		case IDM_SEARCH_GOPREVMARKER8 :
		case IDM_SEARCH_GOPREVMARKER9 :
		case IDM_SEARCH_GOPREVMARKER10 :
		case IDM_SEARCH_GOPREVMARKER_DEF :
		{
			...
			if (id == IDM_SEARCH_GOPREVMARKER1)
				...
				styleID = SCE_UNIVERSAL_FOUND_STYLE_EXT5;
			else if (id == IDM_SEARCH_GOPREVMARKER6)
				styleID = SCE_UNIVERSAL_FOUND_STYLE_EXT6;
			else if (id == IDM_SEARCH_GOPREVMARKER7)
				styleID = SCE_UNIVERSAL_FOUND_STYLE_EXT7;
			else if (id == IDM_SEARCH_GOPREVMARKER8)
				styleID = SCE_UNIVERSAL_FOUND_STYLE_EXT8;
			else if (id == IDM_SEARCH_GOPREVMARKER9)
				styleID = SCE_UNIVERSAL_FOUND_STYLE_EXT9;
			else if (id == IDM_SEARCH_GOPREVMARKER10)
				styleID = SCE_UNIVERSAL_FOUND_STYLE_EXT10;
		...
		case IDM_SEARCH_CLEARALLMARKS :
		{
			...
			_pEditView->clearIndicator(SCE_UNIVERSAL_FOUND_STYLE_EXT6);
			_pEditView->clearIndicator(SCE_UNIVERSAL_FOUND_STYLE_EXT7);
			_pEditView->clearIndicator(SCE_UNIVERSAL_FOUND_STYLE_EXT8);
			_pEditView->clearIndicator(SCE_UNIVERSAL_FOUND_STYLE_EXT9);
			_pEditView->clearIndicator(SCE_UNIVERSAL_FOUND_STYLE_EXT10);
		}
		break;
